...
new_cost = cost(theta0, theta1s, pga.distance, pga.accuracy)
plt.plot(theta1s, new_cost)
...
results = gradient_descent(alpha=0.01, x=pga.distance, y=pga.accuracy)
plt.scatter(range(len(results['costs'])), results['costs'])
plt.show()
