...
def feedforward(X, theta0, theta1):
    h1 = sigmoid_activation(X.T, theta0).T
    h1 = np.column_stack([np.ones(h1.shape[0]), h1])
    out = sigmoid_activation(h1.T, theta1)
    return out
