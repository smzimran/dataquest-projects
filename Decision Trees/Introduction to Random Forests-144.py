...
new_predictions = numpy.round((predictions + predictions2) / 2)

print(roc_auc_score(test['high_income'], new_predictions))
...
for pred in predictions:
    total += pred
total = numpy.round(total/10)

print(roc_auc_score(test['high_income'], total))
